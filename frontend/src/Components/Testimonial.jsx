...
const Testimonial = () => {
  return (
    ...
    <div className='mt-10 mb-8'>
        <Title title="A Tradition of Trust and Excellence" subtitle="The team went above and beyond to help us find our dream home. Their expertise and dedication made a stressful process feel incredibly easy. We couldn't be happier with the results and the service we received."  />
    </div>
